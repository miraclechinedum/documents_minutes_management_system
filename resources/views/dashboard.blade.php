            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <a href="{{ route('documents.show', $document) }}" class="text-sm font-medium text-gray-900 hover:text-primary-600">
                                            {{ $document->title }}
                                        </a>
                ...
                @if($recentDocuments->count() > 0)
                    <div class="px-6 py-3 bg-gray-50 text-center">
                        <a href="{{ route('documents.index') }}" class="text-sm font-medium text-primary-600 hover:text-primary-500">
                            View all documents →
                        </a>
                    </div>
                @endif
