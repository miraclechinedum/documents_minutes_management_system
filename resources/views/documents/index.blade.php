    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            @can('create', App\Models\Document::class)
                <a href="{{ route('documents.create') }}" class="bg-primary-600 hover:bg-primary-700 text-white font-bold py-2 px-4 rounded-lg">
                    Upload Document
                </a>
            @endcan
        </div>
                    ...
                    <form method="GET" action="{{ route('documents.index') }}" class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <select name="filter" id="filter" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
                                    <option value="">All Documents</option>
                                    <option value="my_docs" {{ request('filter') === 'my_docs' ? 'selected' : '' }}>My Documents</option>
                                    <option value="dept_docs" {{ request('filter') === 'dept_docs' ? 'selected' : '' }}>Department Documents</option>
                                    <option value="created_by_me" {{ request('filter') === 'created_by_me' ? 'selected' : '' }}>Created by Me</option>
                                </select>
                            </div>
                        ...
                        <div class="flex justify-between items-center">
                            <div class="flex space-x-2">
                                ...
                                <a href="{{ route('documents.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-700 font-bold py-2 px-4 rounded">
                                    Clear
                                </a>
                            </div>
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <select name="sort" id="sort" onchange="this.form.submit()" class="rounded-md border-gray-300 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
                                ...
                                <select name="direction" onchange="this.form.submit()" class="rounded-md border-gray-300 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm rounded-lg hover:shadow-md transition-shadow duration-200">
                        <div class="p-6">
                            ...
                            <div class="mt-4 flex justify-between items-center">
                                ...
                                <div class="flex space-x-2">
                                    <a href="{{ route('documents.show', $document) }}" class="text-primary-600 hover:text-primary-500 text-sm font-medium">
                                        View
                                    </a>
                                    @can('export', $document)
                                        <a href="{{ route('documents.export', $document) }}" class="text-secondary-600 hover:text-secondary-500 text-sm font-medium">
                                            Export
                                        </a>
                                    @endcan
                                </div>
                ...
                @empty
                    <div class="col-span-full bg-white rounded-lg shadow p-12 text-center">
                        ...
                        @can('create', App\Models\Document::class)
                            <div class="mt-6">
                                <a href="{{ route('documents.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-primary-600 hover:bg-primary-700">
